// **Exercício Jogo de Advinhação**
// Descrever os passos necessários para explicar ao computador como estruturar um jogo de advinhação:
// 1. Escolha um número aleatório de 0 a 999.
// 2. Analisar o número inserido pelo usuário e verificar se este número é maior ou menor que o número gerado inicialmente
// 3. Caso o usuário não tenha acertado o número, solicitar ao usuário que insira um novo número aleatório de 0 a 999
// 4. Informe ao usuário se o número inserido é maior ou menor que o número escolhido pelo computador
// 5. Continue seguindo esses passos enquanto o usuário não acertar o número escolhido pelo computador
// 6. Quando o usuário acertar o número, informar qual é o número e quantas tentativas foram necessárias
